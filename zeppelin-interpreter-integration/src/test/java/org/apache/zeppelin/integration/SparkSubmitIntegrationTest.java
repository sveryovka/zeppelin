  ...
  public void testLocalMode() throws InterpreterException, YarnException {
    try {
      ...
      InterpreterResult interpreterResult =
              sparkSubmitInterpreter.interpret("--master local --class org.apache.spark.examples.SparkPi " +
                      sparkHome + "/examples/jars/spark-examples_2.12-3.0.2.jar", context);
